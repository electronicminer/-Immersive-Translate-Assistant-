<p align="center">
  <h1 align="center">🌊 沉浸翻译助手 (Immersive Translate Assistant)</h1>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/version-9.55-blue.svg" alt="Version">
...
👉 **[Install from GitHub](https://github.com/electronicminer/-Immersive-Translate-Assistant-/raw/main/translator.user.js)**

### 3. API 配置 (必选)
本项目不内置共享 Key，需自行申请（保障隐私与稳定性）：
1. 前往 [SiliconFlow 云平台](https://cloud.siliconflow.cn/) 注册并获取免费 API Key。
2. 在任意网页打开脚本设置面板（点击悬浮球或右键菜单）。
3. 填入 Key 并选择偏好的模型（推荐 `Qwen/Qwen2.5-72B-Instruct` 以获得速度与质量的平衡）。
