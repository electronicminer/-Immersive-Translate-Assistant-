...
// @version     9.14
// @description 智能划词翻译，原地替换。包含苹果 Liquid Glass (毛玻璃) 风格设置面板。支持：iPadOS 磁吸感应、图标动态描边、智能边缘避让、图标无缝退场、滚动锁定、iOS 物理动效。
// @author      WangPan
// @match       *://*/*
...
(function() {
    ...
    const styles = `
        ...
        :root {
            ...
            --sf-tooltip-bg: rgba(255, 255, 255, 0.88); /* 改为亮色毛玻璃适配系统 */
        ...
        #sf-smart-icon {
            ...
            transition: opacity 0.2s, transform 0.2s var(--sf-ease-out-expo), box-shadow 0.2s; /* 移除 left/top 的 transition 以配合磁吸 */
        ...
        #sf-smart-icon:active { transform: scale(0.92) !important; } /* 点击时缩小 */
